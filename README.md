...
Everything was run using the [UAB Cheaha Supercomputer](https://www.uab.edu/it/home/research-computing/cheaha)
...
We are using the Rare Disease V1 Corpus from [Project NLP4Rare-cm-uc3m](https://github.com/cadovid/nlp4rare). For copyright reasons we couldn't upload the dataset to github, if you need it to run this project, please request it [HERE](https://github.com/isegura/NLP4RARE-CM-UC3M).
